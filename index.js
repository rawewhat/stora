...
function mutate() {
  ...
  Object.entries(arguments[0]).forEach(function (_ref) {
    ...
    if (_typeof(value) === 'object') {
      _this2.states[key] = value;
    } else if (typeof value === 'function') {
      _this2.actions[key] = value;
...
function set() {
  ...
  if (_typeof(arguments[0]) === 'object' && !Array.isArray(arguments[0])) {
  ...
  } else if (_typeof(arguments[0]) === 'object' && Array.isArray(arguments[0])) {
    for (var i in arguments[0]) {
      if (Object.prototype.hasOwnProperty.call(arguments[0], i)) {
    ...
    this.states = _objectSpread({}, this.states, _defineProperty({}, arguments[0], _objectSpread({}, this.states[arguments[0]], {}, arguments[1])));
    this.setters.forEach(function (set) {
      set(_this3.states);
    });
